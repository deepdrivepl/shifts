...
def loss_function(outputs, labels):
    ...
    # print(outputs.shape, outputs.dtype, 'labels:', labels.shape, labels.dtype)
    loss = torch.nn.BCEWithLogitsLoss()(outputs, labels.to(outputs.dtype))
