...
def loss_function(outputs, labels):
    ...
    # Log-Cosh loss
    # from S. Jadon (2020) A survey of loss functions for semantic segmentation. (https://arxiv.org/abs/2006.14822)
    loss = torch.log(torch.cosh(dice_loss))
