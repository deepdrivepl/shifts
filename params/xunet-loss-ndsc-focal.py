...
PARAMS = dict(
    ...
    exp_name='xunet-loss-ndsc-focal-lr',
...
def loss_function(outputs, labels):
    ...
    loss = focal_loss * 1.0 + loss_ndsc * 0.01

    return {'loss': loss, 'dice_loss': dice_loss.detach().cpu(), 'focal_loss': focal_loss.detach().cpu(), "ndsc_loss":loss_ndsc.detach().cpu()}
