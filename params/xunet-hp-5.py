...
from monai.transforms import (
    ...
    RandScaleIntensityd, ScaleIntensityd, CropForegroundd)
...
PARAMS = dict(
    ...
    scheduler_params=dict(max_lr=1e-3, div_factor=30, final_div_factor=100, pct_start=0.1),
    monitor=None,
...
def get_train_transforms():
    return Compose(
        [
            ...
            CropForegroundd(keys=["image", "label"], source_key="image", margin=128, allow_smaller=False),
