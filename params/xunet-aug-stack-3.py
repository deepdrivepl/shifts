...
def get_train_transforms():
    return Compose(
        [
            ...
            RandShiftIntensityd(keys="image", offsets=0.1, prob=1.0), # brightness adjustment
            RandScaleIntensityd(keys="image", factors=0.1, prob=1.0), # perturbation
            ...
            RandAffined(keys=['image', 'label'], mode=('bilinear', 'nearest'),
                        ...
                        scale_range=(0.3, 0.3, 0.3), padding_mode='zeros'),
            ...
            Rand3DElasticd(keys=["image", "label"], prob=0.5, sigma_range=(5,7), magnitude_range=(50,150), padding_mode='zeros',
